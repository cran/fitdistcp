...
#' @returns Vector
#' @inheritParams manf
gev_p1a_fd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e4 <- 1/v4
    .e6 <- v4 * .e3/v3
...
#' @returns Matrix
#' @inheritParams manf
gev_p1a_fdd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e4 <- 1/v4
    .e6 <- v4 * .e3/v3
...
#' @returns Vector
#' @inheritParams manf
gev_p1a_pd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e5 <- v4 * .e3/v3
    .e6 <- 1 + .e5
...
#' @returns Matrix
#' @inheritParams manf
gev_p1a_pdd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e5 <- v4 * .e3/v3
    .e6 <- 1/v4
...
#' @returns Matrix
#' @inheritParams manf
gev_p1a_logfdd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e4 <- v4 * .e3
    .e5 <- .e4/v3
...
#' @returns 3d array
#' @inheritParams manf
gev_p1a_logfddd=function (x, t, v1, v2, v3, v4) 
{
    .e3 <- x - (t * v2 + v1)
    .e4 <- v4 * .e3
    .e5 <- .e4/v3

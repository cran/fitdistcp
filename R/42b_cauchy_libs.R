...
cauchy_waic=function(waicscores,x,v1hat,d1,v2hat,fd2,lddi,lddd,lambdad,aderivs){
		if(waicscores){
			...
			if(aderivs) f1f=cauchy_f1fa(x,v1hat,v2hat)
			if(!aderivs)f1f=cauchy_f1f(x,v1hat,d1,v2hat,fd2)

			if(aderivs) f2f=cauchy_f2fa(x,v1hat,v2hat)
			if(!aderivs)f2f=cauchy_f2f(x,v1hat,d1,v2hat,fd2)

			fhatx=dcauchy(x,location=v1hat,scale=v2hat)
...
cauchy_loglik=function(vv,x){
	n=length(x)
	loglik=sum(dcauchy(x,location=vv[1],scale=max(vv[2],.Machine$double.eps),log=TRUE))
	return(loglik)
}
...
# different
	if(mm!=nn){
		...
		for (i in 1:4){
			...
			lmn[i]=sum(dcauchy(x,location=vvd[1],scale=vvd[2],log=TRUE))/nx
		}
...
cauchy_ldd=function(x,v1,d1,v2,fd2){
	...
	for (i in 1:2){
		for (j in i:2){
			ldd[i,j]=cauchy_lmn(x,v1,d1,v2,fd2,i,j)
		}
	}
	for (i in 2:1){
		for (j in 1:(i-1)){
...
# calculate the unique values
	...
	for (i in 1:2){
		for (j in i:2){
			for (k in j:2){
				lddd[i,j,k]=cauchy_lmnp(x,v1,d1,v2,fd2,i,j,k)
			}
		}
	}
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=dcauchy(y,location=v1m1,scale=v200)
	F1p1=dcauchy(y,location=v1p1,scale=v200)
# v2 derivatives
	F2m1=dcauchy(y,location=v100,scale=v2m1)
	F2p1=dcauchy(y,location=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=pcauchy(y,location=v1m1,scale=v200)
	F1p1=pcauchy(y,location=v1p1,scale=v200)
# v2 derivatives
	F2m1=pcauchy(y,location=v100,scale=v2m1)
	F2p1=pcauchy(y,location=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=pcauchy(q00,location=v1m1,scale=v200)
	F1p1=pcauchy(q00,location=v1p1,scale=v200)
# v2 derivatives
	F2m1=pcauchy(q00,location=v100,scale=v2m1)
	F2p1=pcauchy(q00,location=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
	v2p2=v2+2*d2
	F1m2=dcauchy(y,location=v1m2,scale=v200)
	F1m1=dcauchy(y,location=v1m1,scale=v200)
	F100=dcauchy(y,location=v100,scale=v200)
	F1p1=dcauchy(y,location=v1p1,scale=v200)
	F1p2=dcauchy(y,location=v1p2,scale=v200)
# v2 derivative
	F2m2=dcauchy(y,location=v100,scale=v2m2)
	F2m1=dcauchy(y,location=v100,scale=v2m1)
	F200=dcauchy(y,location=v100,scale=v200)
	F2p1=dcauchy(y,location=v100,scale=v2p1)
	F2p2=dcauchy(y,location=v100,scale=v2p2)
# cross derivative
	Fcm1m1=dcauchy(y,location=v1m1,scale=v2m1)
	Fcm1p1=dcauchy(y,location=v1m1,scale=v2p1)
	Fcp1m1=dcauchy(y,location=v1p1,scale=v2m1)
	Fcp1p1=dcauchy(y,location=v1p1,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
	v2p2=v2+2*d2
	F1m2=pcauchy(y,location=v1m2,scale=v200)
	F1m1=pcauchy(y,location=v1m1,scale=v200)
	F100=pcauchy(y,location=v100,scale=v200)
	F1p1=pcauchy(y,location=v1p1,scale=v200)
	F1p2=pcauchy(y,location=v1p2,scale=v200)
# v2 derivative
	F2m2=pcauchy(y,location=v100,scale=v2m2)
	F2m1=pcauchy(y,location=v100,scale=v2m1)
	F200=pcauchy(y,location=v100,scale=v200)
	F2p1=pcauchy(y,location=v100,scale=v2p1)
	F2p2=pcauchy(y,location=v100,scale=v2p2)
# cross derivative
	Fcm1m1=pcauchy(y,location=v1m1,scale=v2m1)
	Fcm1p1=pcauchy(y,location=v1m1,scale=v2p1)
	Fcp1m1=pcauchy(y,location=v1p1,scale=v2m1)
	Fcp1p1=pcauchy(y,location=v1p1,scale=v2p1)
...
# v2 stuff
	...
	F1m2=pcauchy(q00,location=v1m2,scale=v200)
	F1m1=pcauchy(q00,location=v1m1,scale=v200)
	F100=pcauchy(q00,location=v100,scale=v200)
	F1p1=pcauchy(q00,location=v1p1,scale=v200)
	F1p2=pcauchy(q00,location=v1p2,scale=v200)
# v2 derivative
	F2m2=pcauchy(q00,location=v100,scale=v2m2)
	F2m1=pcauchy(q00,location=v100,scale=v2m1)
	F200=pcauchy(q00,location=v100,scale=v200)
	F2p1=pcauchy(q00,location=v100,scale=v2p1)
	F2p2=pcauchy(q00,location=v100,scale=v2p2)
# cross derivative
	Fcm1m1=pcauchy(q00,location=v1m1,scale=v2m1)
	Fcm1p1=pcauchy(q00,location=v1m1,scale=v2p1)
	Fcp1m1=pcauchy(q00,location=v1p1,scale=v2m1)
	Fcp1p1=pcauchy(q00,location=v1p1,scale=v2p1)
...
cauchy_logscores=function(logscores,x,d1=0.01,fd2=0.01,aderivs=TRUE){
	...
	if(logscores){
		...
		for (i in 1:nx){
			...
			dd=dcauchysub(x1,x[i],d1,fd2,aderivs)
...
dcauchysub=function(x,y,d1=0.01,fd2=0.01,aderivs=TRUE){
		...
		v1start=mean(x)
		v2start=sd(x)
		opt=optim(c(v1start,v2start),cauchy_loglik,x=x,control=list(fnscale=-1))
		v1hat=opt$par[1]
		v2hat=opt$par[2]
		ml_params=c(v1hat,v2hat)

# mle
		ml_pdf=dcauchy(y,location=v1hat,scale=v2hat)
		ml_cdf=pcauchy(y,location=v1hat,scale=v2hat)

# rhp
		if(aderivs)	ldd=cauchy_ldda(x,v1hat,v2hat)
		if(!aderivs)ldd=cauchy_ldd(x,v1hat,d1,v2hat,fd2)
		lddi=solve(ldd)
		if(aderivs)	lddd=cauchy_lddda(x,v1hat,v2hat)
		if(!aderivs)lddd=cauchy_lddd(x,v1hat,d1,v2hat,fd2)

		if(aderivs) f1=cauchy_f1fa(y,v1hat,v2hat)
		if(!aderivs)f1=cauchy_f1f(y,v1hat,d1,v2hat,fd2)

		if(aderivs) f2=cauchy_f2fa(y,v1hat,v2hat)
		if(!aderivs)f2=cauchy_f2f(y,v1hat,d1,v2hat,fd2)

# no aderiv for the cdf in cauchy
		p1=cauchy_p1f(y,v1hat,d1,v2hat,fd2)
		p2=cauchy_p2f(y,v1hat,d1,v2hat,fd2)

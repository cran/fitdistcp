...
invgamma_waic=function(waicscores,x,v1hat,fd1,v2hat,fd2,lddi,lddd,lambdad,aderivs){
		if(waicscores){
			...
			if(aderivs) f1f=invgamma_f1fa(x,v1hat,v2hat)
			if(!aderivs)f1f=invgamma_f1f(x,v1hat,fd1,v2hat,fd2)

			if(aderivs) f2f=invgamma_f2fa(x,v1hat,v2hat)
			if(!aderivs)f2f=invgamma_f2f(x,v1hat,fd1,v2hat,fd2)

			fhatx=actuar::dinvgamma(x,shape=v1hat,scale=v2hat)
...
invgamma_loglik=function(vv,x){
	n=length(x)
	loglik=sum(actuar::dinvgamma(x,shape=max(vv[1],.Machine$double.eps),scale=max(vv[2],.Machine$double.eps),log=TRUE))
	return(loglik)
}
...
# different
	if(mm!=nn){
		...
		for (i in 1:4){
			...
			lmn[i]=sum(actuar::dinvgamma(x,shape=vvd[1],scale=vvd[2],log=TRUE))/nx
		}
...
invgamma_ldd=function(x,v1,fd1,v2,fd2){
	...
	for (i in 1:2){
		for (j in i:2){
			ldd[i,j]=invgamma_lmn(x,v1,fd1,v2,fd2,i,j)
		}
	}
	for (i in 2:1){
		for (j in 1:(i-1)){
...
invgamma_lddd=function(x,v1,fd1,v2,fd2){
	...
	for (i in 1:2){
		for (j in i:2){
			for (k in j:2){
				lddd[i,j,k]=invgamma_lmnp(x,v1,fd1,v2,fd2,i,j,k)
			}
		}
	}
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=actuar::dinvgamma(y,shape=v1m1,scale=v200)
	F1p1=actuar::dinvgamma(y,shape=v1p1,scale=v200)
# v2 derivatives
	F2m1=actuar::dinvgamma(y,shape=v100,scale=v2m1)
	F2p1=actuar::dinvgamma(y,shape=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=actuar::pinvgamma(y,shape=v1m1,scale=v200)
	F1p1=actuar::pinvgamma(y,shape=v1p1,scale=v200)
# v2 derivatives
	F2m1=actuar::pinvgamma(y,shape=v100,scale=v2m1)
	F2p1=actuar::pinvgamma(y,shape=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
# v1 derivatives
	F1m1=actuar::pinvgamma(q00,shape=v1m1,scale=v200)
	F1p1=actuar::pinvgamma(q00,shape=v1p1,scale=v200)
# v2 derivatives
	F2m1=actuar::pinvgamma(q00,shape=v100,scale=v2m1)
	F2p1=actuar::pinvgamma(q00,shape=v100,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
	v2p2=v2+2*d2
	F1m2=actuar::dinvgamma(y,shape=v1m2,scale=v200)
	F1m1=actuar::dinvgamma(y,shape=v1m1,scale=v200)
	F100=actuar::dinvgamma(y,shape=v100,scale=v200)
	F1p1=actuar::dinvgamma(y,shape=v1p1,scale=v200)
	F1p2=actuar::dinvgamma(y,shape=v1p2,scale=v200)
# v2 derivative
	F2m2=actuar::dinvgamma(y,shape=v100,scale=v2m2)
	F2m1=actuar::dinvgamma(y,shape=v100,scale=v2m1)
	F200=actuar::dinvgamma(y,shape=v100,scale=v200)
	F2p1=actuar::dinvgamma(y,shape=v100,scale=v2p1)
	F2p2=actuar::dinvgamma(y,shape=v100,scale=v2p2)
# cross derivative
	Fcm1m1=actuar::dinvgamma(y,shape=v1m1,scale=v2m1)
	Fcm1p1=actuar::dinvgamma(y,shape=v1m1,scale=v2p1)
	Fcp1m1=actuar::dinvgamma(y,shape=v1p1,scale=v2m1)
	Fcp1p1=actuar::dinvgamma(y,shape=v1p1,scale=v2p1)
...
# v2 stuff
	...
	v2p1=v2+1*d2
	v2p2=v2+2*d2
	F1m2=actuar::pinvgamma(y,shape=v1m2,scale=v200)
	F1m1=actuar::pinvgamma(y,shape=v1m1,scale=v200)
	F100=actuar::pinvgamma(y,shape=v100,scale=v200)
	F1p1=actuar::pinvgamma(y,shape=v1p1,scale=v200)
	F1p2=actuar::pinvgamma(y,shape=v1p2,scale=v200)
# v2 derivative
	F2m2=actuar::pinvgamma(y,shape=v100,scale=v2m2)
	F2m1=actuar::pinvgamma(y,shape=v100,scale=v2m1)
	F200=actuar::pinvgamma(y,shape=v100,scale=v200)
	F2p1=actuar::pinvgamma(y,shape=v100,scale=v2p1)
	F2p2=actuar::pinvgamma(y,shape=v100,scale=v2p2)
# cross derivative
	Fcm1m1=actuar::pinvgamma(y,shape=v1m1,scale=v2m1)
	Fcm1p1=actuar::pinvgamma(y,shape=v1m1,scale=v2p1)
	Fcp1m1=actuar::pinvgamma(y,shape=v1p1,scale=v2m1)
	Fcp1p1=actuar::pinvgamma(y,shape=v1p1,scale=v2p1)
...
# v2 stuff
	...
	F1m2=actuar::pinvgamma(q00,shape=v1m2,scale=v200)
	F1m1=actuar::pinvgamma(q00,shape=v1m1,scale=v200)
	F100=actuar::pinvgamma(q00,shape=v100,scale=v200)
	F1p1=actuar::pinvgamma(q00,shape=v1p1,scale=v200)
	F1p2=actuar::pinvgamma(q00,shape=v1p2,scale=v200)
# v2 derivative
	F2m2=actuar::pinvgamma(q00,shape=v100,scale=v2m2)
	F2m1=actuar::pinvgamma(q00,shape=v100,scale=v2m1)
	F200=actuar::pinvgamma(q00,shape=v100,scale=v200)
	F2p1=actuar::pinvgamma(q00,shape=v100,scale=v2p1)
	F2p2=actuar::pinvgamma(q00,shape=v100,scale=v2p2)
# cross derivative
	Fcm1m1=actuar::pinvgamma(q00,shape=v1m1,scale=v2m1)
	Fcm1p1=actuar::pinvgamma(q00,shape=v1m1,scale=v2p1)
	Fcp1m1=actuar::pinvgamma(q00,shape=v1p1,scale=v2m1)
	Fcp1p1=actuar::pinvgamma(q00,shape=v1p1,scale=v2p1)
...
invgamma_logscores=function(logscores,x,fd1=0.01,fd2=0.01,aderivs=TRUE){
	...
	if(logscores){
		...
		for (i in 1:nx){
			...
			dd=dinvgammasub(x1,x[i],fd1,fd2,aderivs)
...
# mle
		ml_pdf=actuar::dinvgamma(y,shape=v1hat,scale=v2hat)
		ml_cdf=actuar::pinvgamma(y,shape=v1hat,scale=v2hat)
...
# cp
		...
		if(aderivs) f1=invgamma_f1fa(y,v1hat,v2hat)
		if(!aderivs)f1=invgamma_f1f(y,v1hat,fd1,v2hat,fd2)

		if(aderivs) f2=invgamma_f2fa(y,v1hat,v2hat)
		if(!aderivs)f2=invgamma_f2f(y,v1hat,fd1,v2hat,fd2)

		p1=invgamma_p1f(y,v1hat,fd1,v2hat,fd2)
		p2=invgamma_p2f(y,v1hat,fd1,v2hat,fd2)
